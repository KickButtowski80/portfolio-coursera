...
//   const allLinkElements = document.querySelectorAll('nav ul li a');
//   let maxIntersectingElement = null;
//   let maxIntersectingValue = 0;

//   const resetMaxIntersecting = () => {
//     maxIntersectingElement = null;
//     maxIntersectingValue = 0;
//   };
...
//           if (currentRatio > maxIntersectingValue) {
//             maxIntersectingValue = currentRatio;
        
//           }

      
//           allLinkElements.forEach((link) => link.classList.remove('active'));
//           if (entry.isIntersecting &&  entry.intersectionRatio >= maxIntersectingElement) {
//             linkElement.classList.add('active');
//             setAddressHash(linkElement.getAttribute('href').replace('#', ''));
//           }
//         }
//       });

//       // Reset the max values after processing each batch of entries
//       // resetMaxIntersecting();
//     }, options);
...
const menuItems = {
    'about-me': document.querySelectorAll('a[href="#about-me"]'),
    'skills': document.querySelectorAll('a[href="#skills"]'),
    'use-cases': document.querySelectorAll('a[href="#projects"]'),
    'performance-benefits': document.querySelectorAll('a[href="#recommendations"]')
};
